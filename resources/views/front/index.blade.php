...
<div class="d-flex flex-column justify-content-center align-items-center container-fluid position-relative p-0" style="height: 100vh; background: #4678BF">
    ...
    z-index: 0"></div>
    <div class="row d-flex flex-column align-items-center mx-0 mt-0 w-100" style="z-index: 99; transform: translateY(-150px)">
        <div class="col-12 p-0 hero text-center mt-0 mb-md-5">
            <img src="{{asset('images/racr/logo.png')}}" class="mt-5 mb-5 img-logo" alt="" style="width: 100px">
